...
describe 'Socket#connect_address' do
  describe 'using an unbound socket' do
    it 'raises SocketError' do
      ...
      proc { sock.connect_address }.should raise_error(SocketError)
    end
  end
  ...
  describe 'using an unbound UNIX socket' do
    before do
      @path   = tmp('basic_socket_connect_address_spec.socket', false)
    ...
    it 'raises SocketError' do
      proc { @client.connect_address }.should raise_error(SocketError)
    end
  end
